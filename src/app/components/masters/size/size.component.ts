...
} from 'src/app/shared/validaions/validation.validator';
  ...
  Submit() {
    ...
    switch (this.dbops) {
      case DbOperation.create:
        this._httpService.post(environment.BASE_API_PATH + "SizeMaster/Save/", this.addForm.value).subscribe(res => {
          if (res.isSuccess) {
            this._toastr.success("Record Saved !!", "Size Master");
            this.resetForm();
          } else {
      ...
      case DbOperation.update:
        this._httpService.post(environment.BASE_API_PATH + "SizeMaster/Update/", this.addForm.value).subscribe(res => {
          if (res.isSuccess) {
            this._toastr.success("Record Updated !!", "Size Master");
            this.resetForm();
          } else {
            this._toastr.error(res.errors[0], "Size Master");
          }
